...
<body>
 ...
 <section class="cast-1">
    <form method="POST" class="form" id="form">
    <div class="head">
    <h3>how many casts do you want to add ? <br>  please enter number  ~~~> </h3>
   
  <input type="number" name="number" class="num" min="1" max="15" ><br><br>
 <div class="submit">
 <input type="submit" name="enter" value="enter">
 </div>
  </div>
    </form>
    <form action="" method="POST" enctype="multipart/form-data" class="form_1" id="form_1"> 
        <div id="field_1"></div>
        <input type="submit" name="enter" value="enter" id="submit_1" >
    </form>
