...
<body>
 ...
 <div class="play-container container">
  ...
  <div class="video-container" id="video-container">
        <!-- video-box -->
        <div class="video-box" >
        <video id="myvideo" class="myvideo" src="play-page/y2mate.com - BLUE BEETLE  OFFICIAL FINAL TRAILER_720p.mp4"  controls></video>
        </div>
        <h1 class="close-video" id="close">x</h1>
      </div>
    </div>
  <div class="about-movie container">
    <h2>blue beetle</h2>
    <p>Blue Beetle is one of the oldest comic characters. The first Blue Beetle was Dan Garrett, who premiered in 1940. Fox Comics published the character before he was acquired by Charlton Comics, who relaunched the character as an archeologist who received powers from a magical Scarab </p>
   <!-- movie cast --> 
   <h2 class="cast-heading">movie cast</h2>
   <div class="cast">
    <div class="cast-box">
        <img src="img/casts/blue beetle/belissa escobed - milagro reyes.jpg" alt="" class="cast-img">
        <span class="cast-title">milagro reyes</span>
    </div>
    <div class="cast-box">
        <img src="img/casts/blue beetle/bruna marquezine - jenny kord.jpg" alt="" class="cast-img">
        <span class="cast-title">jenny kord</span>
    </div>
    <div class="cast-box">
        <img src="img/casts/blue beetle/damian alcazar -alberto reyes.jpg" alt="" class="cast-img">
        <span class="cast-title">alberto reyes</span>
    </div>
    <div class="cast-box">
        <img src="img/casts/blue beetle/george lopez - rudy reyes.jpg" alt="" class="cast-img">
        <span class="cast-title">rudy reyes</span>
    </div>
    <div class="cast-box">
        <img src="img/casts/blue beetle/hervey guillen - dr.sanchez.jpg" alt="" class="cast-img">
        <span class="cast-title">uhm ji-won as : lee se-yeon</span>
    </div>
    <div class="cast-box">
        <img src="img/casts/blue beetle/raoul trujilo - conrapax.jpg" alt="" class="cast-img">
        <span class="cast-title">conrapax</span>
    </div>
    <div class="cast-box">
        <img src="img/casts/blue beetle/xolo marduena -blue beetle.jpg" alt="" class="cast-img">
        <span class="cast-title">blue beetle</span>
    </div>
   </div>
</div>
<div class="download">
